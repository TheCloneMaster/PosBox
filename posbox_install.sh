...
#The default port where this PosBox instance will run under (provided you use the command -c in the terminal)
#Set to true if you want to install it, false if you don't need it or have it already installed.
INSTALL_WKHTMLTOPDF="False"
#Set the default PosBox port (you still have to use -c /etc/posbox-server.conf for example to use this.)
OE_PORT="8069"
...
if [ $INSTALL_WKHTMLTOPDF = "True" ]; then
  echo -e "\n---- Install wkhtml and place shortcuts on correct place for PosBox ----"
...
echo -e "\n---- Create PosBox system user ----"
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'POSBOX' --group $OE_USER
